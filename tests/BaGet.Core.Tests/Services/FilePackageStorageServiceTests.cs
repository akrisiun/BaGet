...
namespace BaGet.Core.Tests.Services
{
    ...
    //                _target.GetPackageStreamAsync(new PackageIdentity(_package.Id, _package.Version)));
    //        }
    ...
    //            // Act
    //            var result = await _target.GetPackageStreamAsync(new PackageIdentity(_package.Id, _package.Version));
    ...
    //            // Act
    //            var result = await _target.GetNuspecStreamAsync(new PackageIdentity(_package.Id, _package.Version));
    ...
    //            // Act
    //            await _target.DeleteAsync(new PackageIdentity(_package.Id, _package.Version));
